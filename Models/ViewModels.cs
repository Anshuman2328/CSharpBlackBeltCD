...
namespace dojo_activity_center.Models
{
    public class RegisterUser
    {
        ...
        // make sure to change the length of the required passwords to 3 
    ...
    // this below is custom class for validations, please use stackoverflow for some good examples or goole it. I (ash)
